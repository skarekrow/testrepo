...
class GoogleTest(TestFormat):
    ...
    def getGTestTests(self, path, litConfig, localConfig):
        ...
        try:
            lines = lit36.util.capture([path, '--gtest_list_tests'],
    ...
    def getTestsInExecutable(self, testSuite, path_in_suite, execpath,
        ...
        for testname in self.getGTestTests(execpath, litConfig, localConfig):
            ...
            yield lit36.Test.Test(testSuite, testPath, localConfig, file_path=execpath)
    ...
    def execute(self, test, litConfig):
        ...
        if litConfig.noExecute:
            return lit36.Test.PASS, ''

        out, err, exitCode = lit36.util.executeCommand(
            cmd, env=test.config.environment)

        if not exitCode:
            return lit36.Test.PASS,''

        return lit36.Test.FAIL, out + err
