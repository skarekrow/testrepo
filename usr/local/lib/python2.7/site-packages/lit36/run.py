    ...
    def execute_test(self, test):
        ...
        try:
            ...
            if isinstance(result, tuple):
                code, output = result
                result = lit36.Test.Result(code, output)
            elif not isinstance(result, lit36.Test.Result):
            ...
            output += '\n'
            result = lit36.Test.Result(lit.Test.UNRESOLVED, output)
    ...
    def execute_tests(self, display, jobs, max_time=None,
        ...
        for test in self.tests:
            if test.result is None:
                test.setResult(lit36.Test.Result(lit.Test.UNRESOLVED, '', 0.0))
