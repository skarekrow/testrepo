...
set(Qt5Quick_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.4.1"
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.4.1/QtQuick"
    )
    ...
    foreach(_module_dep ${_Qt5Quick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Quick_FIND_VERSION_EXACT}
    ...
    _populate_Quick_target_properties(RELEASE "libQt5Quick.so.5.4.1" "" )
    ...
    macro(_populate_Quick_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Quick_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick_check_file_exists(${imported_location})
