...
set(Qt5WebKitWidgets_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::WebKitWidgets)
    ...
    foreach(_module_dep ${_Qt5WebKitWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5WebKitWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebKitWidgets_target_properties(RELEASE "libQt5WebKitWidgets.so.5.4.1" "" )
    ...
    macro(_populate_WebKitWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKitWidgets_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKitWidgets_check_file_exists(${imported_location})
