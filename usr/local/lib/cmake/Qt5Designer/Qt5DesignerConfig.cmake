...
set(Qt5Designer_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Designer)
    ...
    set(_Qt5Designer_OWN_INCLUDE_DIRS "${_qt5Designer_install_prefix}/include/qt5/" "${_qt5Designer_install_prefix}/include/qt5/QtDesigner")
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/qt5/QtDesigner/5.4.1"
        "${_qt5Designer_install_prefix}/include/qt5/QtDesigner/5.4.1/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    _populate_Designer_target_properties(RELEASE "libQt5Designer.so.5.4.1" "" )
    ...
    macro(_populate_Designer_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Designer_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Designer_check_file_exists(${imported_location})
