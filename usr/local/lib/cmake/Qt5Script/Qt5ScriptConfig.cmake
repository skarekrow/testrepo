...
set(Qt5Script_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Script)
    ...
    set(_Qt5Script_OWN_INCLUDE_DIRS "${_qt5Script_install_prefix}/include/qt5/" "${_qt5Script_install_prefix}/include/qt5/QtScript")
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.4.1"
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.4.1/QtScript"
    )
    ...
    foreach(_module_dep ${_Qt5Script_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Script_FIND_VERSION_EXACT}
    ...
    _populate_Script_target_properties(RELEASE "libQt5Script.so.5.4.1" "" )
    ...
    macro(_populate_Script_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Script_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Script_check_file_exists(${imported_location})
