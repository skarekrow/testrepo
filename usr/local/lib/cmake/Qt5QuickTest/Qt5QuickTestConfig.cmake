...
set(Qt5QuickTest_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.4.1"
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.4.1/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "libQt5QuickTest.so.5.4.1" "" )
    ...
    macro(_populate_QuickTest_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTest_check_file_exists(${imported_location})
