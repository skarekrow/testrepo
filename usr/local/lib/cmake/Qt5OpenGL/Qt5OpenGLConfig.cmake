...
set(Qt5OpenGL_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.4.1"
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.4.1/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.so.5.4.1" "" )
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})
