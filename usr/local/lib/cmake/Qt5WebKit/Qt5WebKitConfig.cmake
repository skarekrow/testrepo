...
set(Qt5WebKit_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(_Qt5WebKit_OWN_INCLUDE_DIRS "${_qt5WebKit_install_prefix}/include/qt5/" "${_qt5WebKit_install_prefix}/include/qt5/QtWebKit")
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    _populate_WebKit_target_properties(RELEASE "libQt5WebKit.so.5.4.1" "" )
    ...
    macro(_populate_WebKit_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKit_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKit_check_file_exists(${imported_location})
