...
set(Qt5Help_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Help)
    ...
    set(_Qt5Help_OWN_INCLUDE_DIRS "${_qt5Help_install_prefix}/include/qt5/" "${_qt5Help_install_prefix}/include/qt5/QtHelp")
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.4.1"
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.4.1/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    _populate_Help_target_properties(RELEASE "libQt5Help.so.5.4.1" "" )
    ...
    macro(_populate_Help_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Help_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Help_check_file_exists(${imported_location})
