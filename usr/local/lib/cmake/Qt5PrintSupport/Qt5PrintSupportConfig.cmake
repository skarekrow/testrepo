...
set(Qt5PrintSupport_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.4.1"
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.4.1/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "libQt5PrintSupport.so.5.4.1" "" )
    ...
    macro(_populate_PrintSupport_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PrintSupport_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_PrintSupport_check_file_exists(${imported_location})
