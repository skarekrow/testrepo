...
set(Qt5Xml_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.4.1"
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.4.1/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    _populate_Xml_target_properties(RELEASE "libQt5Xml.so.5.4.1" "" )
    ...
    macro(_populate_Xml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Xml_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Xml_check_file_exists(${imported_location})
