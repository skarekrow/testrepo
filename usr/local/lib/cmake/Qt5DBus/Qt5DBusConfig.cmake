...
set(Qt5DBus_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.4.1"
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.4.1/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.4.1" "" )
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5DBus_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})
