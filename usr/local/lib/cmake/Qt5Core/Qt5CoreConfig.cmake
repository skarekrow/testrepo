...
set(Qt5Core_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.4.1"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.4.1/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.4.1" "" )
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Core_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
