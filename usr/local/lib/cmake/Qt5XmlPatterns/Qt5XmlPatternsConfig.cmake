...
set(Qt5XmlPatterns_VERSION_STRING 5.4.1)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(_Qt5XmlPatterns_OWN_INCLUDE_DIRS "${_qt5XmlPatterns_install_prefix}/include/qt5/" "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns")
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.4.1"
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.4.1/QtXmlPatterns"
    )
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.1 ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
    ...
    _populate_XmlPatterns_target_properties(RELEASE "libQt5XmlPatterns.so.5.4.1" "" )
    ...
    macro(_populate_XmlPatterns_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5XmlPatterns_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_XmlPatterns_check_file_exists(${imported_location})
